...
public class DBDelete
{
    ...
    **/
    ...
    /**
    *** Sets the table name for this DBDelete (if not set, the table name of the defined
    *** DBFactory will be used).
    *** @param tableName  The table name
    **/
    public void setTableName(String tableName)
    {
        this.tableName = !StringTools.isBlank(tableName)? tableName : null;
    }
    
    /**
    *** Gets the table name for this DBDelete
    ...
    **/
    public String toString()
    {
        ...
        sb.append(this.getTranslateTableName());
