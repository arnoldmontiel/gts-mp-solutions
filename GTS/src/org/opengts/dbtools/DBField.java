...
public class DBField
{
    ...
    *** @param tableName  The name of the table containing this field
    ...
    **/
    public DBField(String tableName, String colName, 
        ...
        String charSet, Set<String> indexNames)
    {
        ...
        DBFactory fact = DBFactory.getFactoryByName(tableName);
        if (fact != null) {
