...
public class DBProvider
{
    ...
    public static class NameFilterUpperCase
        extends NameFilter
    {
    ...
    public static class NameFilterLowerCase
        extends NameFilter
    {
    ...
    **/
        ...
        throws DBException
    {
        ...
        if (dbp.getID() == DB_DERBY) {
            ...
            showCols      = "SELECT T.TABLENAME,C.COLUMNNAME,C.REFERENCEID,C.COLUMNNUMBER,C.COLUMNDATATYPE,C.COLUMNDEFAULT,N.TYPE FROM SYS.SYSCOLUMNS C, SYS.SYSCONSTRAINTS N, SYS.SYSTABLES T WHERE T.TABLENAME = '"+tableName.toUpperCase()+"' AND T.TABLEID=C.REFERENCEID AND T.TABLEID=N.TABLEID ORDER BY C.COLUMNNUMBER";
    ...
    **/
        ...
        throws SQLException, DBException
    {
        ...
        sb.append("INSERT INTO ").append(recKey.getTranslateTableName());
    ...
    **/
        ...
        throws SQLException, DBException
    {
        ...
        sb.append("UPDATE ").append(recKey.getTranslateTableName());
