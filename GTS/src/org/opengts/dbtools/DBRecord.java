  ...
  //private   DBFieldValues             fieldVals               = null;
    ...
    **/
    public void setChanged(String fieldName, Object oldVal, Object newVal)
    {
        ...
        if (!oldVal.equals(newVal)) {
            ...
            //Print.logDebug("Field did not change: " + recKey.getTableName() + "." + fieldName);
        }
    }
        ...
        throws DBException
    {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // not a fatal error
                Print.logWarn("Key not found: [" + recKey.getTableName() + "] " + wh);
                return null;
            }
        } catch (SQLException sqe) {
            this.setLastCaughtSQLException(sqe);
    ...
    **/
        ...
        throws DBException
    {
        ...
        if (factory.getField(fldUpdTime) == null) {
            //Print.logWarn("Table doesn't contain field: " + factory.getTableName() + "." + fldUpdTime);
            return -1L;
        }
        ...
        throws DBException
    {
        ...
        try {
            ...
            if (this.isLastCaughtSQLExceptionErrorCode(DBFactory.SQLERR_DUPLICATE_KEY)) {
                ...
                Print.logInfo("Duplicate Key Skipped: [" + dbKey.getTableName() + "] " + dbKey);
            } else {
                throw new DBException("Unable to insert record  [" + dbKey.getTableName() + "] '" + dbKey + "'", sqe);
            }
        }
    }
    ...
    **/
    public boolean lockWrite()
        throws DBException
    {
        return this.lock(new String[] { this.getFactory(true).getTableName() }, null);
    }
    ...
    **/
        ...
        throws DBException
    {
        ...
        return this.lock(null, new String[] { this.getFactory(true).getTableName() });
    }
    ...
    **/
    ...
    {
        if (writeTables == null) {
            writeTables = new String[] { this.getFactory(true).getTableName() };
        }
    ...
    **/
    ...
    {
        return this.toXML(sb, indent, fldNames, -1, soapXML);
    }
    ...
    **/
    ...
    {
        return this.toXML(sb, indent, fldNames, sequence, false);
    }
