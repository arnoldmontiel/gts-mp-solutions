...
public class Constants
{
    ...
    public static final String  TITLE_NAME              = "meitrack Example Device Parsing Module";
    public static final String  VERSION                 = "0.0.1";
    public static final String  COPYRIGHT               = Version.getCopyright();
    
    // ------------------------------------------------------------------------

    public static final String  DEVICE_CODE             = DCServerFactory.MEITRACK_NAME;
    ...
    //$$[length:2bytes][ID:7bytes][command:2bytes][data:0-100bytes][checksum:2bytes]\r\n
    public static final int     MIN_PACKET_LENGTH       = 17;
    ...
    public static final boolean TERMINATE_ON_TIMEOUT    = false;
    ...
    public static final long    TIMEOUT_TCP_PACKET      = 8000L;
    // The entire session must complete within this timeframe
    public static final long    TIMEOUT_TCP_SESSION     = 25000L;
