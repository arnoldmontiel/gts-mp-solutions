    ...
    extends AbstractClientPacketHandler
{
    ...
    **/
    ...
    private boolean parseInsertRecord(String s)
    {
        ...
        /* find "GPRMC" */
        //110215232012,+15167493121,GPRMC,042012.000,A,4036.1936,N,07339.6269,W,0.00,  0.00,160211,,,A*75,F,   moved, imei:354779035562413,05,12.6,F:3.85V,0,142,17124
        int gpx = 0;
        ...
        /* status code */
        String  eventCode   = StringTools.trim(fld[gpx + 14]);
