...
public class FileTools
{
    ...
    ***         if the specified file is not a directory.
    **/
    private static boolean _getAllFiles(Collection<File> fileList, File dir, final Set<String> extnSet)
    {
        if ((dir == null) || !dir.isDirectory()) {
            return false;
        } else {
            ...
            // decend all directories
            for (File fd : fileDirs) {
                if (fd.isDirectory()) {
                    FileTools._getAllFiles(fileList, fd, extnSet);
                }
            }
            return true;
        }
    ...
    **/
    public static File[] getFiles(File dir, final Set<String> extnSet, boolean recursiveDecent)
    {
        ...
        if (!recursiveDecent) {
            ...
            FileTools._getAllFiles(fileList, dir, extnSet);
