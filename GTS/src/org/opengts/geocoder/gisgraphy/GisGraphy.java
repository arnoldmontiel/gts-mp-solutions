...
// ----------------------------------------------------------------------------
// Example
//  - http://services.gisgraphy.com/geoloc/findnearbylocation?lat=46.17330&lng=21.29370radius=5000&from=1&to=1&format=xml&placetype=city&indent=true
    ...
    implements ReverseGeocodeProvider, SubdivisionProvider
{
    ...
    **/
    private ReverseGeocode getAddressReverseGeocode(GeoPoint gp, String localeStr) 
    {
        ...
        // parse documents and insert rg properties
    ...
    // lat=46.17330&lng=21.29370radius=1100&from=1&to=1&format=xml&placetype=city&indent=true
