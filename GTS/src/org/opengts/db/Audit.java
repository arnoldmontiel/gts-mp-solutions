...
public class Audit
{
    ...
    public static void userLoginOK(String acctID, String userID, String ipAddr, String bplName)
    {
        ...
        Print.logInfo("Audit Login OK: Time="+nowTimeSec + " Domain="+bplName + " Account="+acctID + " User="+userID + " IPAddr="+ipAddr);
    ...
    {
        long nowTimeSec = DateTime.getCurrentTimeSec();
        Print.logInfo("Audit Rule EMail: Time="+nowTimeSec + " Account="+acctID);
