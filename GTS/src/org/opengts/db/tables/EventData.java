    ...
    implements EventDataProvider, GeoPointProvider
{
    ...
    public static final DBField CustomFieldInfo[] = {
        ...
        new DBField(FLD_driverStatus   , Long.TYPE     , DBField.TYPE_UINT32      , "Driver Status"              , ""),
    ...
    public static final DBField GarminFieldInfo[] = {
        new DBField(FLD_etaTimestamp   , Long.TYPE     , DBField.TYPE_UINT32      , "ETA Time"                   , "format=time"),
        new DBField(FLD_etaUniqueID    , Long.TYPE     , DBField.TYPE_UINT32      , "ETA Unique ID"              , ""),
        new DBField(FLD_etaDistanceKM  , Double.TYPE   , DBField.TYPE_DOUBLE      , "ETA Distance KM"            , "format=#0.0 units=distance"),
        new DBField(FLD_etaLatitude    , Double.TYPE   , DBField.TYPE_DOUBLE      , "ETA Latitude"               , "format=#0.00000"),
        new DBField(FLD_etaLongitude   , Double.TYPE   , DBField.TYPE_DOUBLE      , "ETA Longitude"              , "format=#0.00000"),
        new DBField(FLD_stopID         , Long.TYPE     , DBField.TYPE_UINT32      , "STOP ID"                    , ""),
        new DBField(FLD_stopStatus     , Integer.TYPE  , DBField.TYPE_UINT16      , "STOP Status"                , ""),
        new DBField(FLD_stopIndex      , Integer.TYPE  , DBField.TYPE_UINT16      , "STOP Index"                 , ""),
    };
  ...
  //public static final String FLD_obdType              = "obdType";                // OBD type [0,1=J1708, 2=J1939, 3=OBDII]
    ...
    public static final DBField CANBUSFieldInfo[] = { 
      ...
      //new DBField(FLD_obdType          , Integer.TYPE  , DBField.TYPE_UINT16      , "OBD Type"                   , ""),
        ...
        new DBField(FLD_fuelTemp         , Double.TYPE   , DBField.TYPE_DOUBLE      , "Fuel Temp"                  , "format=#0.00 unit=temp"),
        ...
        new DBField(FLD_engineTorque     , Double.TYPE   , DBField.TYPE_DOUBLE      , "Engine Torque %"            , "format=#0.00"),
        ...
        new DBField(FLD_intakeTemp       , Double.TYPE   , DBField.TYPE_DOUBLE      , "Intake Temperature"         , "format=#0.00 units=temp"),
        new DBField(FLD_brakeGForce      , Double.TYPE   , DBField.TYPE_DOUBLE      , "Brake G Force"              , "format=#0.00"),
        new DBField(FLD_acceleration     , Double.TYPE   , DBField.TYPE_DOUBLE      , "Acceleration"               , "format=#0.00"),
        ...
        new DBField(FLD_airPressure      , Double.TYPE   , DBField.TYPE_DOUBLE      , "Air Supply Pressure"        , "format=#0.00 units=pressure"),
        new DBField(FLD_airFilterPressure, Double.TYPE   , DBField.TYPE_DOUBLE      , "Air Filter Pressure"        , "format=#0.00 units=pressure"),
        ...
        new DBField(FLD_throttlePos      , Double.TYPE   , DBField.TYPE_DOUBLE      , "Throttle Position"          , "format=#0.00"),
        new DBField(FLD_brakePos         , Double.TYPE   , DBField.TYPE_DOUBLE      , "Brake Position"             , "format=#0.00"),
    ...
    public static final DBField AtmosphereFieldInfo[] = {
        ...
        new DBField(FLD_cabinTemp      , Double.TYPE   , DBField.TYPE_DOUBLE      , "Cabin Temperature"          , "format=#0.0 units=temp"),
    };
    ...
    public static final DBField AnalogFieldInfo[] = {
        new DBField(FLD_analog0        , Double.TYPE   , DBField.TYPE_DOUBLE      , "Analog 0"                   , "format=#0.0"),
        new DBField(FLD_analog1        , Double.TYPE   , DBField.TYPE_DOUBLE      , "Analog 1"                   , "format=#0.0"),
        new DBField(FLD_analog2        , Double.TYPE   , DBField.TYPE_DOUBLE      , "Analog 2"                   , "format=#0.0"),
        new DBField(FLD_analog3        , Double.TYPE   , DBField.TYPE_DOUBLE      , "Analog 3"                   , "format=#0.0"),
    };
  ...
  //public static final String FLD_appliedPressure      = "appliedPressure";        // kPa
    ...
    public static final DBField CreationTimeMillisecond[] = {
        ...
        new DBField(FLD_dataPush          , Boolean.TYPE , DBField.TYPE_BOOLEAN   , "Data Push Indicator"       , ALTKEY_eq_pushkey),
    };
    ...
    public static DBFactory<EventData> getFactory()
    {
        if (factory == null) {
            ...
            //Print.logInfo("EventData "+FLD_address+" length = " + EventData.AddressColumnLength);
        }
        return factory;
    }
    ...
    **/
        ...
        boolean isFleet, BasicPrivateLabel bpl)
    {
        ...
        if (this.explicitPushpinIconIndex >= 0) {
            if (DebugPushpins) Print.logInfo("Returning explicit pushpin index: " + this.explicitPushpinIconIndex);
        ...
        if (this.iconIndexProvider != null) {
            ...
            if (iconNdx >= 0) {
                if (DebugPushpins) Print.logInfo("Returning IconIndexProvider pushpin index: " + iconNdx);
                return iconNdx;
            }
        }
        ...
        if (isFleet) {
            ...
            if ((dev != null) && dev.hasPushpinID()) {
                ...
                if (iconNdx >= 0) {
                    if (DebugPushpins) Print.logInfo("Returning Device ["+dev.getDeviceID()+"] pushpin index: " + iconNdx);
                    return iconNdx;
                }
            }
        }
        ...
        if (!isFleet) {
            ...
            if (!StringTools.isBlank(scIcon)) {
                ...
                if (iconNdx >= 0) {
                    if (DebugPushpins) Print.logInfo("Returning StatusCode name pushpin index: " + iconNdx);
                    return iconNdx;
                }
            }
        }
                ...
                try {
                    ...
                    if (result instanceof Number) {
                        ...
                        if (iconNdx >= 0) { // '0' is a valid index
                            if (DebugPushpins) Print.logInfo("Returning StatusCode selector pushpin index: " + iconNdx);
                            return iconNdx;
                        }
                    } else
            ...
            if (!StringTools.isBlank(iconSelector)) {
                try {
                    ...
                    if (result instanceof Number) {
                        int iconNdx = ((Number)result).intValue();
                        if (iconNdx >= 0) { // '0' is a valid index
                            if (DebugPushpins) Print.logInfo("Returning Rule selector pushpin index: " + iconNdx);
                            return iconNdx;
                        }
                    } else
                    if (result instanceof String) {
        ...
        if (isFleet) {
            ...
            if (DebugPushpins) Print.logInfo("Returning 'fleet' pushpin index: " + iconNdx);
            return iconNdx;
        }
        ...
        if (allIconNdx >= 0) { // '0' is a valid index
            if (DebugPushpins) Print.logInfo("Returning 'all' pushpin index: " + allIconNdx);
            return allIconNdx;
        }
        ...
        if (this.getIsLastEvent()) {
            ...
            if (iconNdx >= 0) { // '0' is a valid index
                if (DebugPushpins) Print.logInfo("Returning 'last' pushpin index: " + iconNdx);
                return iconNdx;
            }
        }
        ...
        if (DebugPushpins) Print.logInfo("Returning default pushpin index: " + dftIconNdx);
        return dftIconNdx;
