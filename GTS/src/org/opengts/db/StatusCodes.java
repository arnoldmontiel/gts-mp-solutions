...
// OBC/J1708 status: 0xF900 to 0xF9FF
    ...
    public static final int STATUS_OBC_INFO_5           = 0xF905;   // 
    public static final int STATUS_OBC_INFO_6           = 0xF906;   // 
    public static final int STATUS_OBC_INFO_7           = 0xF907;   // 
    // Description:
...
// ----------------------------------------------------------------------------
    ...
    private static Code _codeArray[] = new Code[] {
        ...
        new Code(STATUS_MOTION_EXCESS_SPEED, "MOT.SPEEDING" , I18N.getString(StatusCodes.class,"StatusCodes.speeding"      ,"Speeding"      )       ),
        ...
        new Code(STATUS_UNPARKED           , "GEO.UNPARK"   , I18N.getString(StatusCodes.class,"StatusCodes.unparked"      ,"UnParked"      )       ),
        ...
        new Code(STATUS_ENGINE_START       , "ENG.START"    , I18N.getString(StatusCodes.class,"StatusCodes.engineStart"   ,"EngineStart"   )       ),
        new Code(STATUS_ENGINE_STOP        , "ENG.STOP"     , I18N.getString(StatusCodes.class,"StatusCodes.engineStop"    ,"EngineStop"    )       ),
        ...
        new Code(STATUS_TRAILER_HOOK       , "TRAILER.HOOK" , I18N.getString(StatusCodes.class,"StatusCodes.trailerHook"   ,"Trailer Hook"  )       ),
        new Code(STATUS_TRAILER_UNHOOK     , "TRAILER.UNHK" , I18N.getString(StatusCodes.class,"StatusCodes.trailerUnook"  ,"Trailer Unhook")       ),
        new Code(STATUS_RFID_CONNECT       , "RFID.CON"     , I18N.getString(StatusCodes.class,"StatusCodes.rfidConnect"   ,"RFID Connect"  )       ),
        new Code(STATUS_RFID_DISCONNECT    , "RFID.DIS"     , I18N.getString(StatusCodes.class,"StatusCodes.rfidDisconnect","RFID Disconn"  )       ),
        ...
        new Code(STATUS_PANIC_OFF          , "PANIC.OFF"    , I18N.getString(StatusCodes.class,"StatusCodes.panicOff"      ,"Panic Off"     )       ),
        new Code(STATUS_ASSIST_ON          , "ASSIST.ON"    , I18N.getString(StatusCodes.class,"StatusCodes.assistOn"      ,"Assist On"     ), true ),
        new Code(STATUS_ASSIST_OFF         , "ASSIST.OFF"   , I18N.getString(StatusCodes.class,"StatusCodes.assistOff"     ,"Assist Off"    )       ),
        new Code(STATUS_MEDICAL_ON         , "MEDICAL.ON"   , I18N.getString(StatusCodes.class,"StatusCodes.medicalOn"     ,"Medical On"    ), true ),
        new Code(STATUS_MEDICAL_OFF        , "MEDICAL.OFF"  , I18N.getString(StatusCodes.class,"StatusCodes.medicalOff"    ,"Medical Off"   )       ),
        new Code(STATUS_TOWING_START       , "TOW.START"    , I18N.getString(StatusCodes.class,"StatusCodes.towStart"      ,"Tow Start"     ), true ),
        new Code(STATUS_TOWING_STOP        , "TOW.STOP"     , I18N.getString(StatusCodes.class,"StatusCodes.towStop"       ,"Tow Stop"      )       ),
        new Code(STATUS_INTRUSION_ON       , "INTRUSION.ON" , I18N.getString(StatusCodes.class,"StatusCodes.intrusionOn"   ,"Intrusion On"  ), true ),
        new Code(STATUS_INTRUSION_OFF      , "INTRUSION.OFF", I18N.getString(StatusCodes.class,"StatusCodes.intrusionOff"  ,"Intrusion Off" )       ),
        new Code(STATUS_BREACH_ON          , "BREACH_ON"    , I18N.getString(StatusCodes.class,"StatusCodes.breachOn"      ,"Breach On"     ), true ),
        new Code(STATUS_BREACH_OFF         , "BREACH_OFF"   , I18N.getString(StatusCodes.class,"StatusCodes.breachOff"     ,"Breach Off"    )       ),
        ...
        new Code(STATUS_EXCESS_CORNERING   , "OBC.CORNERING", I18N.getString(StatusCodes.class,"StatusCodes.cornering"     ,"Cornering"     )       ),
        new Code(STATUS_IMPACT             , "OBC.IMPACT"   , I18N.getString(StatusCodes.class,"StatusCodes.impact"        ,"Impact"        ), true ),
        new Code(STATUS_FUEL_REFILL        , "FUEL.REFILL"  , I18N.getString(StatusCodes.class,"StatusCodes.fuelRefill"    ,"FuelRefill"    )       ),
        ...
        new Code(STATUS_POWER_OFF          , "POWEROFF"     , I18N.getString(StatusCodes.class,"StatusCodes.powerOff"      ,"PowerOff"      )       ),
        new Code(STATUS_POWER_ON           , "POWERON"      , I18N.getString(StatusCodes.class,"StatusCodes.powerOn"       ,"PowerOn"       )       ),
