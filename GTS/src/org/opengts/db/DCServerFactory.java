...
public class DCServerFactory
{
    ...
    //Developed by MP HT Solutions
    public static final String  MEITRACK_NAME                  = "meitrack";      // [3x482] VT310
    /* servlet-based DCS */
    ...
    **/
        ...
        String cmdType, String cmdName, String cmdArgs[])
    {
        ...
        if (cmdPort <= 0) {
            ...
            DCServerFactory.ResultCode result = DCServerConfig.SendSMSCommand(protoHndlr, device, commandStr);
    ...
    **/
    ...
    /**
    *** Return an array of "set Last Valid GPS Location" property names
    *** @param name  The server name
    *** @return An array of "set Last Valid GPS Location" property names
    **/
