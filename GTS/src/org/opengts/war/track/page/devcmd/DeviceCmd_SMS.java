    ...
    implements DeviceCmdHandler
{
    ...
    public boolean hasSmsCommands(RequestProperties reqState)
    {
        ...
        if (!ListTools.isEmpty(this._getCommandMap(dcs,pl,user,DCServerFactory.CMDTYPE_ADMIN))) {
            return true;
        }
        if (!ListTools.isEmpty(this._getCommandMap(dcs,pl,user,DCServerFactory.CMDTYPE_SYSADMIN))) {
            return true;
        }
    ...
    private Map<String,DCServerConfig.Command> _getCommandMap(DCServerConfig dcs, BasicPrivateLabel privLabel, User user, String type)
    {
    ...
    **/
        ...
        throws IOException
    {
        ...
        if (dcs != null) {
            Map<String,DCServerConfig.Command> cmdMap_admin = this._getCommandMap(dcs, privLabel, reqState.getCurrentUser(), DCServerFactory.CMDTYPE_ADMIN);
            ...
            Map<String,DCServerConfig.Command> cmdMap_sysadmin = this._getCommandMap(dcs, privLabel, reqState.getCurrentUser(), DCServerFactory.CMDTYPE_SYSADMIN);
    ...
    **/
    public String handleDeviceCommands(RequestProperties reqState, Device selDev)
    {
        ...
        DCServerConfig dcs = DeviceCmd_SMS.getServerConfig(selDev,privLabel);
        Map<String,DCServerConfig.Command> cmdMap_all = this._getCommandMap(dcs, privLabel, reqState.getCurrentUser(), null);
    ...
    **/
    private RTProperties sendCommand(Device device, DCServerConfig.Command command, String cmdArgs[])
    {
        ...
        DCServerFactory.ResultCode result = DCServerConfig.SendSMSCommand(protoHandler, device, smsCmd);
