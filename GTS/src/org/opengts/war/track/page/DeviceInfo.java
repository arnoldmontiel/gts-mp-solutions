    ...
    implements Constants
{
  ...
  //public  static final String COMMAND_INFO_REFRESH        = "refreshList";
    ...
    public  static final String PARM_MAINT_LAST_            = "d_mntlast";      // read-only
    public  static final String PARM_MAINT_NEXT_            = "d_mntnext";      // read-only
    public  static final String PARM_MAINT_RESET_           = "d_mntreset";     // checkbox
    public  static final String PARM_MAINT_INTERVAL_0       = PARM_MAINT_INTERVAL_+"0";
    public  static final String PARM_MAINT_LAST_0           = PARM_MAINT_LAST_+"0";
    public  static final String PARM_MAINT_NEXT_0           = PARM_MAINT_NEXT_+"0";
    public  static final String PARM_MAINT_RESET_0          = PARM_MAINT_RESET_+"0";
    public  static final String PARM_MAINT_INTERVAL_1       = PARM_MAINT_INTERVAL_+"1";
    public  static final String PARM_MAINT_LAST_1           = PARM_MAINT_LAST_+"1";
    public  static final String PARM_MAINT_NEXT_1           = PARM_MAINT_NEXT_+"1";
    public  static final String PARM_MAINT_RESET_1          = PARM_MAINT_RESET_+"1";
      ...
      //String  worderID  = AttributeTools.getRequestString(request, PARM_WORKORDER_ID      , "");
        try {
            ...
            if (Device.supportsPeriodicMaintenance()) {
                Account.DistanceUnits distUnits = Account.getDistanceUnits(currAcct);
                // Maintenance #0
              //String  maintLst0 = AttributeTools.getRequestString(request, PARM_MAINT_LAST_0  , null);
              //String  maintNxt0 = AttributeTools.getRequestString(request, PARM_MAINT_NEXT_0  , null);
                long    mInterv0  = AttributeTools.getRequestLong(request, PARM_MAINT_INTERVAL_0, 0L);
                double  intrvKM0  = distUnits.convertToKM((double)mInterv0);
                boolean mReset0   = !StringTools.isBlank(AttributeTools.getRequestString(request,PARM_MAINT_RESET_0,null));
                selDev.setMaintIntervalKM0(intrvKM0);
                if (mReset0) {
                    selDev.setMaintOdometerKM0(selDev.getLastOdometerKM());
                }
                // Maintenane #1
                long    mInterv1  = AttributeTools.getRequestLong(request, PARM_MAINT_INTERVAL_1, 0L);
                double  intrvKM1  = distUnits.convertToKM((double)mInterv1);
                boolean mReset1   = !StringTools.isBlank(AttributeTools.getRequestString(request,PARM_MAINT_RESET_1,null));
            ...
            if (_showNotificationFields(privLabel)) {
                ...
                String  ruleSel     = ntfyRuleSel? AttributeTools.getRequestString( request, PARM_DEV_RULE_SEL    ,  null) : null;
                String  ruleDesc    = ntfyRuleSel? AttributeTools.getRequestString( request, PARM_DEV_RULE_DESC   ,  null) : null;
                String  ruleSubj    = ntfyRuleSel? AttributeTools.getRequestString( request, PARM_DEV_RULE_SUBJ   ,  null) : null;
                String  ruleText    = ntfyRuleSel? AttributeTools.getRequestString( request, PARM_DEV_RULE_TEXT   ,  null) : null;
              //String  ruleWrap    = ntfyRuleSel? AttributeTools.getRequestString( request, PARM_DEV_RULE_WRAP   ,  null) : null;
                 // Allow Notification
        ...
        throws IOException
    {
      ...
      //boolean refreshList  = deviceCmd.equals(COMMAND_INFO_REFRESH);
        ...
        if (selectDevice) {
            ...
            if (SubmitMatch(submitProps,i18n.getString("DeviceInfo.properties","Properties"))) {
                if (!allowProp) {
        ...
        if (_uiEdit || _uiView) {
            ...
            HTML_CONTENT = new HTMLOutput(CommonServlet.CSS_CONTENT_FRAME, m) {
                public void write(PrintWriter out) throws IOException {
                    ...
                    out.println(FormRow_TextField(PARM_CREATE_DATE      , false      , i18n.getString("DeviceInfo.creationDate","Creation Date")+":"       , createStr, 24, 24));
                    ...
                    if (Device.supportsPeriodicMaintenance()) {
                        ...
                        // Maintenance / Interval
                        for (int ndx = 0; ndx < Device.getPeriodicMaintenanceCount(); ndx++) {
                            ...
                            out.println(FormRow_TextField(PARM_MAINT_LAST_+ndx, false, i18n.getString("DeviceInfo.mainLast","Last Maintenance #{0}",ndxStr) +":" , lastMaintSt, 10, 11, distUnitsStr));
                            ...
                            out.print(Form_TextField(PARM_MAINT_INTERVAL_+ndx, _uiEdit, String.valueOf((long)intrv), 10, 11));
                            out.print("&nbsp;" + distUnitsStr);
                            if (_uiEdit) {
                                out.print(" &nbsp;&nbsp;(" + i18n.getString("DeviceInfo.maintReset","Check to Reset Service") + " ");
                                out.print(Form_CheckBox(PARM_MAINT_RESET_+ndx, PARM_MAINT_RESET_+ndx, _uiEdit, false, null, null));
                                out.print(")");
                            }
                            out.print("</td>");
                            out.print("</tr>\n");
                    ...
                    if (ntfyOK) {
                        ...
                        if (ntfyRuleSel) {
                            ...
                            out.println(FormRow_TextField(PARM_DEV_RULE_SEL  , ntfyEdit  , i18n.getString("DeviceInfo.ruleSelector","Rule Selector")+":"     , (_selDev!=null)?_selDev.getNotifySelector():"", 75, 90));
