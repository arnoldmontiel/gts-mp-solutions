...
public class GoogleMobileService
{
    ...
    public static final String MOBILE_SERVICE_URI = "http://www.google.com/glm/mmap";
    ...
    **/
    ...
    public static GeoPoint getCellTowerLocation(int mcc, int mnc, int cid, int lac)
    {
        
        try {
            byte req[] = GoogleMobileService.encodeRequest(mcc, mnc, cid, lac);
            byte rsp[] = HTMLTools.readPage_POST(MOBILE_SERVICE_URI, HTMLTools.MIME_BINARY(), req, 5000);
            return GoogleMobileService.decodeLocation(rsp);
        } catch (Throwable th) {
    ...
    /* get CellTower location */
    public static GeoPoint getCellTowerLocation(CellTower cti)
    {
        ...
        /* return response */
        return GoogleMobileService.getCellTowerLocation(mcc, mnc, cid, lac);
    ...
    public static void main(String argv[])
    {
        ...
        GeoPoint gp = getCellTowerLocation(cti);
